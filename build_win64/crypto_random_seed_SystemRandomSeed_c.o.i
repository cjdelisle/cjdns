...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06408292849779764;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x036244810662644156;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x07310984148266726;
...
struct Linker_x08104038897349353;
...
# 24 "./crypto/random/seed/RtlGenRandomSeed.h"
    struct Linker_x06032323182541048;
...
# 24 "./crypto/random/seed/DevUrandomRandomSeed.h"
    struct Linker_x034407288570847916;
...
struct Linker_x025728398522608864;
