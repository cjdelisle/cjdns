...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06555874734505889;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x009300945500738855;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x009851495418049327;
...
struct Linker_x03052551493176381;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x05166656054124921;
...
struct Linker_x029720841854483093;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x05374396773125054;
...
struct Linker_x06901268444522737;
...
struct Linker_x04747730840670461;
...
struct Linker_x08968498644792893;
...
struct Linker_x004156024697562;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x007817924775290663;
...
struct Linker_x0989409916174236;
...
struct Linker_x02955402884640068;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x07385811148495902;
...
struct Linker_x048367821033315384;
...
# 21 "./util/ArrayList.h"
struct Linker_x039087013602255327;
...
struct Linker_x019603886809072257;
...
struct Linker_x05798606106238127;
...
struct Linker_x05821520182569042;
...
struct Linker_x012484802536927075;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x06690513920073129;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x05504523531592878;
...
struct Linker_x08986737704632719;
...
struct Linker_x027121376962197563;
...
struct Linker_x02976884094949117;
...
struct Linker_x06228208325389555;
...
struct Linker_x01368158950380367;
...
struct Linker_x006002968896343197;
...
struct Linker_x07991506904443182;
...
struct Linker_x027680855214904687;
...
struct Linker_x017536089834583635;
...
struct Linker_x09067815572874978;
...
# 22 "./net/TUNAdapter.h"
struct Linker_x0826199275976851;
...
struct Linker_x04843008001861242;
...
struct Linker_x0932352843477011;
...
struct Linker_x020427599411964192;
...
struct Linker_x07773743275822476;
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vContext) Identity_ptr = ((struct Context*) vContext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc5a27f54482ab8bbull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Main_fuzz_test.c"), (70), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc5a27f54482ab8bbull))"); } } while (0); Identity_ptr; }));
...
# 100 "./test/Main_fuzz_test.c"
    ...
    (ctx)->Identity_verifier = ((unsigned long) 0xc5a27f54482ab8bbull);
    ctx->base = base;
...
void Main_fuzz_test_FUZZ_MAIN(void* vctx, struct Message* msg)
{
    ...
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vctx) Identity_ptr = ((struct Context*) vctx); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc5a27f54482ab8bbull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Main_fuzz_test.c"), (143), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc5a27f54482ab8bbull))"); } } while (0); Identity_ptr; }));
    ...
    do {             struct Er_Ret* Er_ret = Message_epush(msg, &udp, 8);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Main_fuzz_test.c", 174, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Main_fuzz_test.c", 174, Er_ret));                 }             }                  } while (0);
    ...
    do {             struct Er_Ret* Er_ret = TUNMessageType_push(msg, ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x86DD))); _x >> 8 | _x << 8; }))));                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Main_fuzz_test.c", 185, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Main_fuzz_test.c", 185, Er_ret));                 }             }                  } while (0);
