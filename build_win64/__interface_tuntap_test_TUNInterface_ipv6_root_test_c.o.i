...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06813277672045899;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x044430726704457557;
...
struct Linker_x08007039777906737;
...
# 21 "./util/Bits.h"
struct Linker_x0061616024510054324;
...
struct Linker_x08785339129923839;
...
struct Linker_x09687200897332873;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x01310228146569068;
...
struct Linker_x003130392472396215;
...
struct Linker_x02873897386298794;
...
struct Linker_x03009560149769792;
...
struct Linker_x032996276975211214;
...
struct Linker_x07450542201018517;
...
struct Linker_x09793065125335851;
...
struct Linker_x08918052154114786;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x08400579498959828;
...
struct Linker_x007110177140750573;
...
# 33 "./interface/tuntap/test/TUNInterface_ipv6_root_test.c"
    ...
    struct Iface* tun = (__extension__({             struct Iface* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = TUNInterface_new(&Er_returnVal,                        ((void *)0)                       , assignedIfName, 0, base, logger, alloc);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("TUNInterface_ipv6_root_test.c", 39, Er_ret);                 } else {                     Er__assertFail(Er_unwind("TUNInterface_ipv6_root_test.c", 39, Er_ret));                 }             }                      Er_returnVal;         }));
    addrA->flags |= (1<<1);
    addrA->prefix = 126;
    do {             struct Er_Ret* Er_ret = NetDev_addAddress(assignedIfName, addrA, logger, alloc);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("TUNInterface_ipv6_root_test.c", 42, Er_ret);                 } else {                     Er__assertFail(Er_unwind("TUNInterface_ipv6_root_test.c", 42, Er_ret));                 }             }                  } while (0);
