...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x07919317472001077;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x014744776827708894;
...
struct Linker_x06956473836216852;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x05219581078973756;
...
struct Linker_x023129315766177205;
...
# 21 "./interface/tuntap/TUNInterface.h"
# 1 "./util/events/EventBase.h" 1
# 20 "./util/events/EventBase.h"
struct Linker_x007283241945798213;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x02634195499550507;
...
struct Linker_x08201608495112032;
...
# 19 "./interface/tuntap/windows/TAPInterface.h"
# 1 "./exception/Except.h" 1
# 21 "./exception/Except.h"
struct Linker_x07877416920857365;
...
# 20 "./interface/tuntap/windows/TAPInterface.h" 2




struct Linker_x09254399152099924;
...
struct Linker_x0260930909540795;
...
struct Linker_x029718000484622475;
...
struct Linker_x006515585513338573;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x03743625041316181;
...
{
    struct TAPInterface* tap = TAPInterface_new(interfaceName, 
# 30 "interface/tuntap/TUNInterface_win64.c" 3 4
                                                              ((void *)0)
# 30 "interface/tuntap/TUNInterface_win64.c"
                                                                  , logger, base, alloc);
    if (!tap) {
        *Er_returnValP = ((void *)0); return (struct Er_Ret*)0;
    }

    CString_safeStrncpy(assignedInterfaceName, tap->assignedName, 256);
    if (isTapMode) { *Er_returnValP = &tap->generic; return (struct Er_Ret*)0; }
    ...
    *Er_returnValP = &arp->internal; return (struct Er_Ret*)0;
}
