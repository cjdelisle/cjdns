...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08345539256159393;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x033211551285103;
...
struct Linker_x08444048495889716;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x08166809413160647;
...
# 31 "exception/Er.c" 3 4
                              ((void *)0)
# 31 "exception/Er.c"
                                  , 0, "%s:%d ", file, line);
        do { if (!((written >= 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Er.c"), (32), "(written >= 0)"); } } while (0);

        va_list argsCopy;
        
# 35 "exception/Er.c" 3 4
       __builtin_va_copy(
# 35 "exception/Er.c"
       argsCopy
# 35 "exception/Er.c" 3 4
...
# 35 "exception/Er.c"
                              ;
        int written2 = vsnprintf(
# 36 "exception/Er.c" 3 4
                                ((void *)0)
# 36 "exception/Er.c"
                                    , 0, format, argsCopy);
        do { if (!((written2 >= 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Er.c"), (37), "(written2 >= 0)"); } } while (0);
        
# 38 "exception/Er.c" 3 4
       __builtin_va_end(
# 38 "exception/Er.c"
       argsCopy
# 38 "exception/Er.c" 3 4
...
# 38 "exception/Er.c"
        ...
        char* buf = Allocator__calloc((alloc),(len),(1),"Er.c",42);

        snprintf(buf, len, "%s:%d ", file, line);
        vsnprintf(&buf[written], len - written, format, args);
        struct Er_Ret* res = Allocator__calloc((alloc),(sizeof(struct Er_Ret)),(1),"Er.c",46);
        res->message = buf;
        
# 48 "exception/Er.c" 3 4
       __builtin_va_end(
# 48 "exception/Er.c"
       args
# 48 "exception/Er.c" 3 4
