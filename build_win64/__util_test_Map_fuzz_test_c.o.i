...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x04071777695505252;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x08433953040531497;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x06292667638937051;
...
struct Linker_x034357208495851665;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x03874535034065487;
...
struct Linker_x0035531878406680706;
...
struct Linker_x08181493034508713;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x022323261769734937;
...
struct Linker_x004854915885565947;
...
struct Linker_x011357564102194151;
...
void Map_fuzz_test_FUZZ_MAIN(void* vctx, struct Message* fuzz)
{
    ...
    uint32_t size = (__extension__({             uint16_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Message_epop16be(&Er_returnVal, fuzz);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Map_fuzz_test.c", 36, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Map_fuzz_test.c", 36, Er_ret));                 }             }                      Er_returnVal;         })) % 4096;
