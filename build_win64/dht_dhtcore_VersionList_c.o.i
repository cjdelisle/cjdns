...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x01476213089391567;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x0572770180425682;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x07069807457011132;
...
struct Linker_x0110826146704045;
...
struct Linker_x08971180344582048;
...
# 21 "./io/ArrayWriter.h"
struct Linker_x09008320732217252;
# 30 "./io/ArrayWriter.h"
...
# 21 "./io/ArrayReader.h"
struct Linker_x047037727780571337;
# 30 "./io/ArrayReader.h"
