...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x022456147920578973;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x017064186064776266;
...
struct Linker_x033515981480796553;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x05741010189349001;
...
struct Linker_x043888154997255513;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08939800051436935;
...
struct Linker_x04547984598488908;
...
struct Linker_x0029168662259337674;
...
# 43 "interface/tuntap/BSDMessageTypeWrapper.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9b89d45526ebafd3ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BSDMessageTypeWrapper.c"), (43), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9b89d45526ebafd3ull))"); } } while (0); Identity_ptr; })); }));

    if (msg->length < 4) { return 
# 45 "interface/tuntap/BSDMessageTypeWrapper.c" 3 4
                                 ((void *)0)
# 45 "interface/tuntap/BSDMessageTypeWrapper.c"
                                     ; }
    ...
    if (afType_be == ctx->afInet_be) {
        ...
        do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "BSDMessageTypeWrapper.c", 54, "Message of unhandled aftype [0x%04x]", ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(afType_be))); _x >> 8 | _x << 8; })))); } } while (0)
                                                      ;
        return 
# 56 "interface/tuntap/BSDMessageTypeWrapper.c" 3 4
              ((void *)0)
# 56 "interface/tuntap/BSDMessageTypeWrapper.c"
                  ;
    }
...
# 67 "interface/tuntap/BSDMessageTypeWrapper.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9b89d45526ebafd3ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BSDMessageTypeWrapper.c"), (67), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9b89d45526ebafd3ull))"); } } while (0); Identity_ptr; })); }));
...
struct BSDMessageTypeWrapper* BSDMessageTypeWrapper_new(struct Allocator* alloc, struct Log* log)
{
    ...
    (context)->Identity_verifier = ((unsigned long) 0x9b89d45526ebafd3ull);
