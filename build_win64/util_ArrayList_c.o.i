...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x017587091051362602;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x05503378983884748;
...
struct Linker_x09943782527280483;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x010762981603723776;
...
void* ArrayList_new(struct Allocator* alloc, int initialCapacity)
{
    ...
    l->alloc = alloc;
    (l)->Identity_verifier = ((unsigned long) 0xdbcb5a3c45285663ull);
    return l;
}

void* ArrayList_get(struct ArrayList* vlist, int number)
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (47), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull))"); } } while (0); Identity_ptr; }));
...
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (54), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull))"); } } while (0); Identity_ptr; }));
...
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (68), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull))"); } } while (0); Identity_ptr; }));
...
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (85), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull))"); } } while (0); Identity_ptr; }));
    QSort(list->elements, list->length, sizeof(char*), compare);
}

void* ArrayList_clone(struct ArrayList* vlist, struct Allocator* alloc)
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (91), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xdbcb5a3c45285663ull))"); } } while (0); Identity_ptr; }));
