...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x05993324285894162;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x07709679180469877;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x08449233533597849;
...
struct Linker_x042536280419371963;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x05034204835714335;
...
struct Linker_x05320833390260513;
...
struct Linker_x014538453731708367;
...
struct Linker_x07273193571457646;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x05582541179803453;
...
struct Linker_x04724503031103726;
...
static void simpleTest(struct Allocator* alloc, struct Random* rand)
{
    ...
    uint32_t* val;
    struct Set_OfInts_Iter UniqueName_70dbcce231702b268b63; for (Set_OfInts_iter(set, &UniqueName_70dbcce231702b268b63); ((val) = UniqueName_70dbcce231702b268b63.val); Set_OfInts_iterNext(&UniqueName_70dbcce231702b268b63)) {
        int size = set->size;
