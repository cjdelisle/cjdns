...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x015568295458629655;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x03775080649073881;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x05697169766916059;
...
struct Linker_x009677731296842085;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x05554583077679518;
...
struct Linker_x0877617534016907;
...
struct Linker_x06914326403157056;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x07086740253486323;
...
struct Linker_x06846330971363919;
...
# 21 "./util/ArrayList.h"
struct Linker_x08368773508304383;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x014001456719269467;
...
struct Linker_x017455152944148988;
...
# 1 "./wire/Message.h" 1
# 23 "./wire/Message.h"
struct Linker_x01579815294776865;
...
struct Linker_x010481264754281483;
...
struct Linker_x07949021261792693;
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x08138795955111373;
# 32 "./util/Hex.h"
...
struct Linker_x08996941617705443;
