...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x022128695333007276;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x038342964791541534;
...
# 23 "./exception/Er.h"
struct Linker_x05861708326538486;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x04894825460665688;
...
struct Linker_x06543119253644427;
...
struct Linker_x0264377680403014;
...
struct Linker_x07351505593796532;
...
struct Linker_x09139273248728139;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x04434008942364165;
...
struct Linker_x09913407012256918;
...
struct Linker_x030532673020215917;
...
struct Linker_x06020875810579625;
...
struct Linker_x007859930522964964;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x08220231861529366;
...
struct Linker_x003472551387492029;
...
struct Linker_x07096688149253745;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x012901406749859645;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x0763819055965441;
...
struct Linker_x05695409241557499;
...
struct Linker_x016641481766756394;
...
struct Linker_x05776071530248676;
...
struct Linker_x08591974621180474;
...
struct Linker_x09176136717163976;
...
struct Linker_x07006552972351496;
...
struct Linker_x04276792245369705;
...
struct Linker_x05825837951766877;
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x23999029452eef25ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Janitor_admin.c"), (47), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x23999029452eef25ull))"); } } while (0); Identity_ptr; }));
...
void Janitor_admin_register(struct Janitor* janitor, struct Admin* admin, struct Allocator* alloc)
{
    struct Context* ctx = Allocator__clone((alloc),((&(struct Context) { .admin = admin, .alloc = alloc, .janitor = janitor })),sizeof(*((&(struct Context) { .admin = admin, .alloc = alloc, .janitor = janitor }))),"Janitor_admin.c",76)
       ...
       ;
    (ctx)->Identity_verifier = ((unsigned long) 0x23999029452eef25ull);
