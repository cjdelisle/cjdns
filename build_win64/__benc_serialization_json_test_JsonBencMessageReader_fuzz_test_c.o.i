...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x03735294520776127;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x05650173441276545;
...
struct Linker_x08739981276897713;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x0022787305699703886;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x007638764770186479;
...
struct Linker_x09283695055100709;
...
struct Linker_x044292167950725236;
...
struct Linker_x031309951658669255;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x044547958176105906;
...
struct Linker_x023553285688132686;
...
struct Linker_x06808678072174685;
...
# 23 "./benc/serialization/json/test/JsonBencMessageReader_fuzz_test.c"
                   ;
    const char* res = JsonBencMessageReader_readNoExcept(fuzz, alloc, &out, 
