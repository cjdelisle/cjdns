...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x05951979674781775;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x010617466148983223;
...
struct Linker_x031022933768446004;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09255037187634159;
...
struct Linker_x06645081122619416;
...
struct Linker_x09208290782100599;
...
struct Linker_x08758312594344979;
...
struct Linker_x0038616140222980544;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x04563082844882449;
...
struct Linker_x007680348130255976;
...
struct Linker_x013404733133503433;
...
struct Linker_x09594731734360746;
...
struct Linker_x05625642228287451;
...
struct Linker_x07182464621104439;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x0520645418707901;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x03918172604301924;
...
struct Linker_x038884742682348894;
...
struct Linker_x06693075928734882;
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x07021973676590776;
# 32 "./util/Hex.h"
...
struct Linker_x08810786780541426;
...
struct Linker_x01862396017118011;
...
{
    struct AdminLog* log = (__extension__ ({ __typeof__((struct AdminLog*) vAdminLog) Identity_ptr = ((struct AdminLog*) vAdminLog); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AdminLog.c"), (154), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull))"); } } while (0); Identity_ptr; }));
...
static void doLog(struct Log* genericLog,
                  ...
                  va_list args)
{
    struct AdminLog* log = (__extension__ ({ __typeof__((struct AdminLog*) genericLog) Identity_ptr = ((struct AdminLog*) genericLog); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AdminLog.c"), (183), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull))"); } } while (0); Identity_ptr; }));
    String* message = 
...
{
    struct AdminLog* log = (__extension__ ({ __typeof__((struct AdminLog*) vcontext) Identity_ptr = ((struct AdminLog*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AdminLog.c"), (230), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull))"); } } while (0); Identity_ptr; }));
...
{
    struct AdminLog* log = (__extension__ ({ __typeof__((struct AdminLog*) vcontext) Identity_ptr = ((struct AdminLog*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AdminLog.c"), (275), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull))"); } } while (0); Identity_ptr; }));
...
{
    struct AdminLog* log = (__extension__ ({ __typeof__((struct AdminLog*) vcontext) Identity_ptr = ((struct AdminLog*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AdminLog.c"), (300), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull))"); } } while (0); Identity_ptr; }));
...
{
    struct AdminLog* log = (__extension__ ({ __typeof__((struct AdminLog*) vcontext) Identity_ptr = ((struct AdminLog*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AdminLog.c"), (315), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x858bc674aaca3f60ull))"); } } while (0); Identity_ptr; }));
                                 ...
                                 struct EventBase* base)
{
    struct AdminLog* log = Allocator__clone((alloc),((&(struct AdminLog) { .pub = { .print = doLog }, .admin = admin, .alloc = alloc, .rand = rand, .base = base })),sizeof(*((&(struct AdminLog) { .pub = { .print = doLog }, .admin = admin, .alloc = alloc, .rand = rand, .base = base }))),"AdminLog.c",340)
       ...
       ;
    (log)->Identity_verifier = ((unsigned long) 0x858bc674aaca3f60ull);
