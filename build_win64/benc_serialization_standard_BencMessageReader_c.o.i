...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0043182025577484406;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06211426648194167;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x06999946395565935;
...
struct Linker_x07009783226205761;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x027151860655944193;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x05482104972076725;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x08401740243638773;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x03105137208119604;
...
struct Linker_x03832250817710967;
...
struct Linker_x06761835354264556;
...
# 1 "./util/Base10.h" 1
# 21 "./util/Base10.h"
struct Linker_x04777181061490734;
...
# 24 "benc/serialization/standard/BencMessageReader.c" 2

static __attribute__ ((warn_unused_result)) struct Er_Ret* readGeneric(Object* *Er_returnValP, struct Message* msg, struct Allocator* alloc);

static __attribute__ ((warn_unused_result)) struct Er_Ret* readInt(int64_t *Er_returnValP, struct Message* msg, struct Allocator* alloc)
{
    int64_t num = (__extension__({             int64_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Base10_read(&Er_returnVal, msg);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 29, Er_ret); }             Er_returnVal;         }));
    if ((__extension__({             uint8_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Message_epop8h(&Er_returnVal, msg);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 30, Er_ret); }             Er_returnVal;         })) != 'e') {
        do { struct Er_Ret* Er_ret = Er__raise("BencMessageReader.c", 31, msg->alloc, "Int not terminated with 'e'"); return Er_ret;; } while (0);
    }
    *Er_returnValP = num; return (struct Er_Ret*)0;
}

static __attribute__ ((warn_unused_result)) struct Er_Ret* readString(String* *Er_returnValP, struct Message* msg, struct Allocator* alloc)
{
    int64_t len = (__extension__({             int64_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Base10_read(&Er_returnVal, msg);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 38, Er_ret); }             Er_returnVal;         }));
    if (len < 0) {
        do { struct Er_Ret* Er_ret = Er__raise("BencMessageReader.c", 40, alloc, "Negative string length"); return Er_ret;; } while (0);
    }
    if ((__extension__({             uint8_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Message_epop8h(&Er_returnVal, msg);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 42, Er_ret); }             Er_returnVal;         })) != ':') {
        do { struct Er_Ret* Er_ret = Er__raise("BencMessageReader.c", 43, alloc, "String not deliniated with a ':'"); return Er_ret;; } while (0);
    }
    if (len > msg->length) {
        do { struct Er_Ret* Er_ret = Er__raise("BencMessageReader.c", 46, alloc, "String too long"); return Er_ret;; } while (0);
    }
    String* str = String_newBinary(
# 48 "benc/serialization/standard/BencMessageReader.c" 3 4
                                  ((void *)0)
# 48 "benc/serialization/standard/BencMessageReader.c"
                                      , len, alloc);
    do {             struct Er_Ret* Er_ret = Message_epop(msg, str->bytes, len);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 49, Er_ret); }         } while (0);
    *Er_returnValP = str; return (struct Er_Ret*)0;
}

static __attribute__ ((warn_unused_result)) struct Er_Ret* readList(List* *Er_returnValP, struct Message* msg, struct Allocator* alloc)
{
    struct List_Item* last = 
# 55 "benc/serialization/standard/BencMessageReader.c" 3 4
                            ((void *)0)
# 55 "benc/serialization/standard/BencMessageReader.c"
                                ;
    for (;;) {
        uint8_t chr = (__extension__({             uint8_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Message_epop8h(&Er_returnVal, msg);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 57, Er_ret); }             Er_returnVal;         }));
        if (chr == 'e') {
            List* out = Allocator__malloc((alloc),(sizeof(List)),"BencMessageReader.c",59);
            *out = last;
            *Er_returnValP = out; return (struct Er_Ret*)0;
        }
        do {             struct Er_Ret* Er_ret = Message_epush8h(msg, chr);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 63, Er_ret); }         } while (0);

        struct List_Item* item = Allocator__malloc((alloc),(sizeof(struct List_Item)),"BencMessageReader.c",65);
        item->elem = (__extension__({             Object* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = readGeneric(&Er_returnVal, msg, alloc);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 66, Er_ret); }             Er_returnVal;         }));
        item->next = last;
        last = item;
    }
}

static __attribute__ ((warn_unused_result)) struct Er_Ret* readDict(Dict* *Er_returnValP, struct Message* msg, struct Allocator* alloc)
{
    struct Dict_Entry* last = 
# 74 "benc/serialization/standard/BencMessageReader.c" 3 4
                             ((void *)0)
# 74 "benc/serialization/standard/BencMessageReader.c"
                                 ;
    for (;;) {
        uint8_t chr = (__extension__({             uint8_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Message_epop8h(&Er_returnVal, msg);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 76, Er_ret); }             Er_returnVal;         }));
        if (chr == 'e') {
            Dict* out = Allocator__malloc((alloc),(sizeof(Dict)),"BencMessageReader.c",78);
            *out = last;
            *Er_returnValP = out; return (struct Er_Ret*)0;
        }
        do {             struct Er_Ret* Er_ret = Message_epush8h(msg, chr);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 82, Er_ret); }         } while (0);

        struct Dict_Entry* entry = Allocator__malloc((alloc),(sizeof(struct Dict_Entry)),"BencMessageReader.c",84);
        entry->key = (__extension__({             String* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = readString(&Er_returnVal, msg, alloc);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 85, Er_ret); }             Er_returnVal;         }));
        entry->val = (__extension__({             Object* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = readGeneric(&Er_returnVal, msg, alloc);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 86, Er_ret); }             Er_returnVal;         }));
        entry->next = last;
        last = entry;
    }
}
...
static __attribute__ ((warn_unused_result)) struct Er_Ret* readGeneric(Object* *Er_returnValP, struct Message* msg, struct Allocator* alloc)
{
    uint8_t chr = (__extension__({             uint8_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Message_epop8h(&Er_returnVal, msg);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 94, Er_ret); }             Er_returnVal;         }));
    Object* out = Allocator__calloc((alloc),(sizeof(Object)),(1),"BencMessageReader.c",95);
    switch (chr) {
        case 'l': {
            out->type = Object_LIST;
            out->as.list = (__extension__({             List* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = readList(&Er_returnVal, msg, alloc);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 99, Er_ret); }             Er_returnVal;         }));
            break;
        }
        case 'd': {
            out->type = Object_DICT;
            out->as.dictionary = (__extension__({             Dict* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = readDict(&Er_returnVal, msg, alloc);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 104, Er_ret); }             Er_returnVal;         }));
            break;
        }
        case 'i': {
            out->type = Object_INTEGER;
            out->as.number = (__extension__({             int64_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = readInt(&Er_returnVal, msg, alloc);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 109, Er_ret); }             Er_returnVal;         }));
            break;
        }
        case '0':
        case '1':
        ...
        case '9': {
            ...
            do {             struct Er_Ret* Er_ret = Message_epush8h(msg, chr);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 123, Er_ret); }         } while (0);
            out->as.string = (__extension__({             String* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = readString(&Er_returnVal, msg, alloc);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 124, Er_ret); }             Er_returnVal;         }));
            break;
        }
        default: do { struct Er_Ret* Er_ret = Er__raise("BencMessageReader.c", 127, alloc, "Unexpected character in message [%c]", (char)chr); return Er_ret;; } while (0);
    }
    *Er_returnValP = out; return (struct Er_Ret*)0;
}
...
__attribute__ ((warn_unused_result)) struct Er_Ret* BencMessageReader_read(Dict* *Er_returnValP, struct Message* msg, struct Allocator* alloc)
{
    if ((__extension__({             uint8_t Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Message_epop8h(&Er_returnVal, msg);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 134, Er_ret); }             Er_returnVal;         })) != 'd') {
        do { struct Er_Ret* Er_ret = Er__raise("BencMessageReader.c", 135, alloc, "Message does not begin with a 'd' to open the dictionary"); return Er_ret;; } while (0);
    }
    Dict* out = (__extension__({             Dict* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = readDict(&Er_returnVal, msg, alloc);             if (Er_ret) { return Er_unwind("BencMessageReader.c", 137, Er_ret); }             Er_returnVal;         }));
    *Er_returnValP = out; return (struct Er_Ret*)0;
}
...
{
    struct Er_Ret* er = 
# 144 "benc/serialization/standard/BencMessageReader.c" 3 4
                       ((void *)0)
# 144 "benc/serialization/standard/BencMessageReader.c"
                           ;
    Dict* out = (__extension__({             Dict* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = BencMessageReader_read(&Er_returnVal, msg, alloc);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = &er;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("BencMessageReader.c", 145, Er_ret);                 } else {                     Er__assertFail(Er_unwind("BencMessageReader.c", 145, Er_ret));                 }             }                      Er_returnVal;         }));
    if (er) {
        return er->message;
    }
    *outPtr = out;
    return 
# 150 "benc/serialization/standard/BencMessageReader.c" 3 4
          ((void *)0)
# 150 "benc/serialization/standard/BencMessageReader.c"
              ;
}
