...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0377503465832679;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x04193176958658389;
...
struct Linker_x025779107293996284;
...
# 21 "./util/Bits.h"
struct Linker_x08057157640799326;
...
struct Linker_x01299645196231094;
...
struct Linker_x09448044455267566;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08075083498558975;
...
struct Linker_x029359250395698866;
...
struct Linker_x06359531372755542;
...
struct Linker_x07841320583601479;
...
struct Linker_x06345229734487969;
...
struct Linker_x05033939081219279;
...
struct Linker_x08534441002248105;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x019099776185516526;
...
struct Linker_x06009794800558939;
...
struct Linker_x08012449056097495;
...
struct Linker_x04316883440223158;
...
struct Linker_x09536742948450503;
...
# 31 "./interface/tuntap/test/TAPWrapper_root_test.c"
    ...
    struct Iface* tap = (__extension__({             struct Iface* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = TUNInterface_new(&Er_returnVal,                        ((void *)0)                       , assignedIfName, 1, base, log, alloc);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("TAPWrapper_root_test.c", 37, Er_ret);                 } else {                     Er__assertFail(Er_unwind("TAPWrapper_root_test.c", 37, Er_ret));                 }             }                      Er_returnVal;         }));
    ...
    addrA->flags |= (1<<1);
    addrA->prefix = 126;
    do {             struct Er_Ret* Er_ret = NetDev_addAddress(assignedIfName, addrA, log, alloc);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("TAPWrapper_root_test.c", 46, Er_ret);                 } else {                     Er__assertFail(Er_unwind("TAPWrapper_root_test.c", 46, Er_ret));                 }             }                  } while (0);
