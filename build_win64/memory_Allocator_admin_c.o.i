...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08681733704551513;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x009039426130412886;
...
struct Linker_x04588387910794631;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09001327056991302;
...
struct Linker_x003126843205336205;
...
struct Linker_x07663665321389641;
...
struct Linker_x05999318482102842;
...
struct Linker_x04872196350797655;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x06128034848753974;
...
struct Linker_x05448280022757457;
...
struct Linker_x03036936385065361;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x036284454475508965;
...
struct Linker_x01075626828992633;
...
struct Linker_x09298981214075024;
...
{
    struct Allocator_admin_pvt* ctx = (__extension__ ({ __typeof__((struct Allocator_admin_pvt*)vcontext) Identity_ptr = ((struct Allocator_admin_pvt*)vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x6dd40d6c297e1b31ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator_admin.c"), (31), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x6dd40d6c297e1b31ull))"); } } while (0); Identity_ptr; }));
...
{
    struct Allocator_admin_pvt* ctx = (__extension__ ({ __typeof__((struct Allocator_admin_pvt*)vcontext) Identity_ptr = ((struct Allocator_admin_pvt*)vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x6dd40d6c297e1b31ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator_admin.c"), (40), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x6dd40d6c297e1b31ull))"); } } while (0); Identity_ptr; }));
...
void Allocator_admin_register(struct Allocator* alloc, struct Admin* admin)
{
    struct Allocator_admin_pvt* ctx = Allocator__clone((alloc),((&(struct Allocator_admin_pvt) { .alloc = alloc, .admin = admin })),sizeof(*((&(struct Allocator_admin_pvt) { .alloc = alloc, .admin = admin }))),"Allocator_admin.c",48)
       ...
       ;
    (ctx)->Identity_verifier = ((unsigned long) 0x6dd40d6c297e1b31ull);
