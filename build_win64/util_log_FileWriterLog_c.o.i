...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x042233463822989425;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x010668326796694982;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08843555223148154;
...
struct Linker_x04514705899121949;
...
struct Linker_x08912625103989051;
...
# 1 "./io/FileWriter.h" 1
# 21 "./io/FileWriter.h"
struct Linker_x036102558328161716;
# 30 "./io/FileWriter.h"
