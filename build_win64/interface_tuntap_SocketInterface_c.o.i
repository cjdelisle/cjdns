...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x09023805849822577;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x01405906870486624;
...
struct Linker_x028720295831138665;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x04253799042421802;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x05665411428274234;
...
# 21 "./util/Bits.h"
struct Linker_x009296303096853076;
...
struct Linker_x07689839291835356;
...
# 22 "./interface/tuntap/SocketInterface.h" 2


struct Linker_x035942074100813604;

# 1 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stdbool.h" 1 3 4
# 27 "./interface/tuntap/SocketInterface.h" 2
# 38 "./interface/tuntap/SocketInterface.h"
__attribute__ ((warn_unused_result)) struct Er_Ret* SocketInterface_new(struct Iface* *Er_returnValP, const char* socketFullPath, struct EventBase* base, struct Log* logger, struct Allocator* alloc)
...
# 18 "./util/events/Pipe.h"
# 1 "./exception/Except.h" 1
# 21 "./exception/Except.h"
struct Linker_x019945438463354348;
...
# 19 "./util/events/Pipe.h" 2





struct Linker_x01481775440186115;
...
{
    do { if (logger && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(logger, Log_Level_INFO, "SocketInterface.c", 26, "Initializing socket: %s;", socketFullPath); } } while (0);
    struct Pipe* p = (__extension__({             struct Pipe* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Pipe_named(&Er_returnVal, socketFullPath, base, logger, alloc);             if (Er_ret) { return Er_unwind("SocketInterface.c", 27, Er_ret); }             Er_returnVal;         }));
    *Er_returnValP = &p->iface; return (struct Er_Ret*)0;
}
