...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08057177812409615;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x05069274485232111;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x01983992471935827;
...
struct Linker_x01527617500922578;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x01775494915406386;
...
struct Linker_x010341703537661773;
...
struct Linker_x06655782725024273;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x025684559969717546;
...
struct Linker_x008645075469293029;
...
struct Linker_x013467160152572477;
...
struct Linker_x03289418486932285;
...
struct Linker_x02084885070221043;
...
# 28 "./crypto/test/Sign_test.c"
    ...
    do {             struct Er_Ret* Er_ret = Message_epush(msg, "hello world", 12);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Sign_test.c", 38, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Sign_test.c", 38, Er_ret));                 }             }                  } while (0);
