...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0958137729977022;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09495897815353718;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x0805979498677174;
...
struct Linker_x06345839237946023;
...
# 20 "./crypto/random/seed/DevUrandomRandomSeed.h" 2
    ...
    struct Linker_x08386561868094735;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09075537531519968;
