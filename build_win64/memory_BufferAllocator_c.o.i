...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x07591441377186701;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x08900145225935743;
...
struct Linker_x006313360413449565;
...
struct Linker_x0019254775701064597;
...
struct Linker_x004363225803924209;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x06304169131623929;
...
{
    (__extension__ ({ __typeof__(context) Identity_ptr = (context); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3aa4e71239b1b2d1ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BufferAllocator.c"), (63), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3aa4e71239b1b2d1ull))"); } } while (0); Identity_ptr; }));
                                       ...
                                       int line)
{
    ...
    (&stackAlloc)->Identity_verifier = ((unsigned long) 0x3aa4e71239b1b2d1ull);
