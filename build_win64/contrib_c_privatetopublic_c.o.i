...
struct Linker_x0014328048724161047;
...
struct Linker_x014412753209692974;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x036901501206301246;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x08250697972728354;
...
struct Linker_x005281446827511371;
...
struct Linker_x040078551528771755;
# 34 "./dht/Address.h"
struct Address
{
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x07440277239800028;
# 32 "./util/Hex.h"
