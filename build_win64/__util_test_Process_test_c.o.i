...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x05445834060334129;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x0033373231904645806;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x07205465731952394;
...
struct Linker_x09449373784103079;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x08053760019057374;
...
struct Linker_x0045592346734212086;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x0937548794935819;
...
struct Linker_x08864204770532922;
...
struct Linker_x016798302915178076;
...
struct Linker_x0546677019149006;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x006490525152705895;
...
struct Linker_x09402486631940654;
...
struct Linker_x007221289461619773;
...
struct Linker_x030121668024509374;
...
struct Linker_x0748327550229205;
...
# 20 "./util/test/Process_test.c" 2
# 1 "./util/events/Timeout.h" 1
# 20 "./util/events/Timeout.h"
struct Linker_x039795005792916305;
...
struct Linker_x05869043155219997;
...
#pragma pack(pop)
# 9 "/usr/share/mingw-w64/include/fcntl.h" 2 3
# 33 "./util/test/Process_test.c" 2
...
{
    struct Context* c = (__extension__ ({ __typeof__((struct Context*) p->userData) Identity_ptr = ((struct Context*) p->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x5b4b238d124db992ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (57), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x5b4b238d124db992ull))"); } } while (0); Identity_ptr; }));
    struct Allocator* alloc = Allocator__child((c->alloc),"Process_test.c",58);
    struct Message* msg = Message_new(0, 256, alloc);
    do {             struct Er_Ret* Er_ret = Message_epush(msg, "IT WORKS!", CString_strlen("IT WORKS!") + 1);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Process_test.c", 60, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Process_test.c", 60, Er_ret));                 }             }                  } while (0);
    do {             struct Er_Ret* Er_ret = AddrIface_pushAddr(msg, addr);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Process_test.c", 61, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Process_test.c", 61, Er_ret));                 }             }                  } while (0);
    if (!0) {
        Message_setAssociatedFd(msg, c->fd);
    }
    printf("Parent sending message [%s] len [%d]\n", "IT WORKS!", msg->length);
    Iface_send(&c->iface, msg);
    Allocator__free((alloc),"Process_test.c",67);
}

static __attribute__ ((warn_unused_result)) struct Iface* receiveMessageParent(struct Message* msg, struct Iface* iface)
{
    struct Context* c = (__extension__ ({ __typeof__((struct Context*) iface) Identity_ptr = ((struct Context*) iface); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x5b4b238d124db992ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (72), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x5b4b238d124db992ull))"); } } while (0); Identity_ptr; }));
    (__extension__({             struct Sockaddr* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = AddrIface_popAddr(&Er_returnVal, msg);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Process_test.c", 73, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Process_test.c", 73, Er_ret));                 }             }                      Er_returnVal;         }));
    do { if (!((msg->length == (int)CString_strlen("INDEED")+1))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (74), "(msg->length == (int)CString_strlen(\"INDEED\")+1)"); } } while (0);
    do { if (!((!__builtin_memcmp(msg->bytes,"INDEED",CString_strlen("INDEED")+1)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (75), "(!__builtin_memcmp(msg->bytes,\"INDEED\",CString_strlen(\"INDEED\")+1))"); } } while (0);
    Allocator__free((c->alloc),"Process_test.c",76);
    return 
# 77 "./util/test/Process_test.c" 3 4
          ((void *)0)
# 77 "./util/test/Process_test.c"
              ;
}

static void timeout(void* vNULL)
{
    do { if (!((!"timed out."))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (82), "(!\"timed out.\")"); } } while (0);
}

static void onConnectionChild(struct Pipe* p, int status)
{
    do { if (!((!status))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (87), "(!status)"); } } while (0);
...
{
    struct Context* c = (__extension__ ({ __typeof__((struct Context*) iface) Identity_ptr = ((struct Context*) iface); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x5b4b238d124db992ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (93), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x5b4b238d124db992ull))"); } } while (0); Identity_ptr; }));
    struct Message* m = Message_clone(msg, c->alloc);
    printf("Child received message\n");
    do { if (!((m->length == (int)CString_strlen("IT WORKS!")+1))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (96), "(m->length == (int)CString_strlen(\"IT WORKS!\")+1)"); } } while (0);
    do { if (!((!__builtin_memcmp(m->bytes,"IT WORKS!",CString_strlen("IT WORKS!")+1)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (97), "(!__builtin_memcmp(m->bytes,\"IT WORKS!\",CString_strlen(\"IT WORKS!\")+1))"); } } while (0);

    if (!0) {
        int fd = Message_getAssociatedFd(msg);
        if (lseek(fd, 0, 
# 101 "./util/test/Process_test.c" 3
                        0
# 101 "./util/test/Process_test.c"
                                ) < 0) {
            printf("lseek(%d) failed: errno %s\n", fd, strerror(
# 102 "./util/test/Process_test.c" 3 4
                                                               (*_errno())
# 102 "./util/test/Process_test.c"
                                                                    ));
            Assert_failure("lseek()");
        }
        uint8_t* buf = Allocator__calloc((msg->alloc),(2048),(1),"Process_test.c",105);
        if (read(fd, buf, 1024) < 0) {
            printf("read(%d) failed: errno %s\n", fd, strerror(
# 107 "./util/test/Process_test.c" 3 4
                                                              (*_errno())
# 107 "./util/test/Process_test.c"
                                                                   ));
            Assert_failure("read()");
        }
    ...
    do {             struct Er_Ret* Er_ret = Message_eshift(m, -((int)CString_strlen("IT WORKS!")));                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Process_test.c", 117, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Process_test.c", 117, Er_ret));                 }             }                  } while (0);
    do {             struct Er_Ret* Er_ret = Message_epush(m, "INDEED", CString_strlen("INDEED"));                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Process_test.c", 118, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Process_test.c", 118, Er_ret));                 }             }                  } while (0);

    Iface_send(&c->iface, m);


    Allocator__free((c->alloc),"Process_test.c",123);

    return 
# 125 "./util/test/Process_test.c" 3 4
          ((void *)0)
# 125 "./util/test/Process_test.c"
              ;
}

static void child(char* name, struct Context* ctx)
{
    struct Pipe* pipe = (__extension__({             struct Pipe* Er_returnVal;             __builtin_memset(&Er_returnVal, 0, sizeof(Er_returnVal));             struct Er_Ret* Er_ret = Pipe_named(&Er_returnVal, name, ctx->base, ctx->log, ctx->alloc);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("Process_test.c", 130, Er_ret);                 } else {                     Er__assertFail(Er_unwind("Process_test.c", 130, Er_ret));                 }             }                      Er_returnVal;         }));
...
# 136 "./util/test/Process_test.c"
   ), (2000), (ctx->base), (ctx->alloc), "Process_test.c", 136);
    EventBase_beginLoop(ctx->base);
}

int Process_test_main(int argc, char** argv);int Process_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<20),"Process_test.c",142);
    struct EventBase* eb = EventBase_new(alloc);
    struct Log* log = FileWriterLog_new(
# 144 "./util/test/Process_test.c" 3
                                       (__acrt_iob_func(1))
# 144 "./util/test/Process_test.c"
                                             , alloc);
    struct Context* ctx = Allocator__calloc((alloc),(sizeof(struct Context)),(1),"Process_test.c",145);
    (ctx)->Identity_verifier = ((unsigned long) 0x5b4b238d124db992ull);
    ctx->alloc = alloc;
    ctx->base = eb;
    ctx->log = log;
...
# 157 "./util/test/Process_test.c" 3 4
                                                ((void *)0)
# 157 "./util/test/Process_test.c"
                                                    );
    char randName[32] = {0};
    ...
    if (!0) {
        String* textName =
            String_printf(alloc, "%s%scjdns-test-%s.txt", "/tmp", "/", randName);
        int fd = open(textName->bytes, 
# 164 "./util/test/Process_test.c" 3
                                      0x0100 
# 164 "./util/test/Process_test.c"
                                              | 
# 164 "./util/test/Process_test.c" 3
                                                0x0200 
# 164 "./util/test/Process_test.c"
...
# 164 "./util/test/Process_test.c"
                                                                , 0600);
        do { if (!((fd >= 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (165), "(fd >= 0)"); } } while (0);
        do { if (!((write(fd, name->bytes, name->len) == ((ssize_t)name->len)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (166), "(write(fd, name->bytes, name->len) == ((ssize_t)name->len))"); } } while (0);
        ctx->fd = fd;
        unlink(textName->bytes);
    }

    struct PipeServer* pipe = PipeServer_named(name->bytes, eb, 
# 171 "./util/test/Process_test.c" 3 4
                                                               ((void *)0)
# 171 "./util/test/Process_test.c"
                                                                   , log, alloc);
    pipe->userData = ctx;
    ...
    do { if (!((path != 
# 178 "./util/test/Process_test.c" 3 4
   ((void *)0)
# 178 "./util/test/Process_test.c"
   ))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (178), "(path != ((void *)0))"); } } while (0);
# 187 "./util/test/Process_test.c"
        do { if (!((path[0] == '/'))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (187), "(path[0] == '/')"); } } while (0);


    char* args[] = { "Process_test", "child", name->bytes, 
# 190 "./util/test/Process_test.c" 3 4
                                                          ((void *)0) 
# 190 "./util/test/Process_test.c"
                                                               };

    do { if (!((!Process_spawn(path, args, eb, alloc, 
# 192 "./util/test/Process_test.c" 3 4
   ((void *)0)
# 192 "./util/test/Process_test.c"
   )))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Process_test.c"), (192), "(!Process_spawn(path, args, eb, alloc, ((void *)0)))"); } } while (0);

    Timeout__setTimeout((timeout), (
# 194 "./util/test/Process_test.c" 3 4
   ((void *)0)
# 194 "./util/test/Process_test.c"
   ), (2000), (eb), (alloc), "Process_test.c", 194);
