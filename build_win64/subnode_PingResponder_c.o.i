...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08904832048194904;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x05453537369125783;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x04494886619156384;
...
# 23 "./exception/Er.h"
struct Linker_x043042034066415424;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x07550632697403683;
...
struct Linker_x03344627621862377;
...
struct Linker_x09482704209288648;
...
struct Linker_x032862104911124845;
...
struct Linker_x09579598371953719;
...
struct Linker_x009216624107034543;
...
struct Linker_x07321315531268389;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x018115267682101766;
...
struct Linker_x02833194807798527;
...
struct Linker_x04112846634199945;
# 34 "./dht/Address.h"
struct Address
{
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x0180466987443207;
...
struct Linker_x06466911013313255;
...
struct Linker_x014960441931035917;
...
struct Linker_x05091922276037932;
...
struct Linker_x04829982369151984;
...
static void onPing(Dict* msg,
                   ...
                   struct MsgCore_Handler* handler)
{
    struct PingResponder_pvt* prp = (__extension__ ({ __typeof__((struct PingResponder_pvt*) handler->userData) Identity_ptr = ((struct PingResponder_pvt*) handler->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3072173e92fc9bcaull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PingResponder.c"), (35), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3072173e92fc9bcaull))"); } } while (0); Identity_ptr; }));
                                        ...
                                        struct BoilerplateResponder* br)
{
    ...
    (prp)->Identity_verifier = ((unsigned long) 0x3072173e92fc9bcaull);
    prp->log = log;
    prp->alloc = alloc;
    prp->msgCore = msgCore;
