...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x02856995203015895;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x042537335955980593;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x048477957026946594;
...
struct Linker_x05981895269778159;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x021666930431479714;
...
struct Linker_x045021937463242145;
...
struct Linker_x06981055101914675;
...
# 1 "./io/FileReader.h" 1
# 21 "./io/FileReader.h"
struct Linker_x07473469345261317;
...
struct Linker_x02287674316796744;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x012498008088313228;
