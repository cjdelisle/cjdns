...
struct Linker_x0772186187832999;
...
struct Linker_x09803295153692368;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06487034049509566;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x0697612393314831;
...
struct Linker_x07531525080809998;
...
struct Linker_x06601126692584602;
# 34 "./dht/Address.h"
struct Address
{
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x07137485380530442;
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x0708245595000786;
# 32 "./util/Hex.h"
