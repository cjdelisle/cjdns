...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x009902157782903909;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x007830236962265036;
...
# 23 "./exception/Er.h"
struct Linker_x0031137930600796615;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x0029851534873682306;
...
struct Linker_x06158428616470961;
...
struct Linker_x006583231868775252;
...
struct Linker_x06827706408822318;
...
struct Linker_x08200768458445504;
...
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xfe5a0cc03456ccc6ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PacketHeaderToUDPAddrIface.c"), (34), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xfe5a0cc03456ccc6ull))"); } } while (0); Identity_ptr; })); }));

    struct Sockaddr_storage ss;
    do {             struct Er_Ret* Er_ret = Message_epop(message, &ss, context->pub.udpIf.addr->addrLen);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("PacketHeaderToUDPAddrIface.c", 37, Er_ret);                 } else {                     Er__assertFail(Er_unwind("PacketHeaderToUDPAddrIface.c", 37, Er_ret));                 }             }                  } while (0);
    ...
    udp.checksum_be = 0;
    do {             struct Er_Ret* Er_ret = Message_epush(message, &udp, sizeof(struct Headers_UDPHeader));                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("PacketHeaderToUDPAddrIface.c", 45, Er_ret);                 } else {                     Er__assertFail(Er_unwind("PacketHeaderToUDPAddrIface.c", 45, Er_ret));                 }             }                  } while (0);
...
# 53 "interface/addressable/PacketHeaderToUDPAddrIface.c"
    ...
    do {             struct Er_Ret* Er_ret = Message_epush(message, &ip, sizeof(struct Headers_IP6Header));                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("PacketHeaderToUDPAddrIface.c", 62, Er_ret);                 } else {                     Er__assertFail(Er_unwind("PacketHeaderToUDPAddrIface.c", 62, Er_ret));                 }             }                  } while (0);
...
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xfe5a0cc03456ccc6ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PacketHeaderToUDPAddrIface.c"), (70), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xfe5a0cc03456ccc6ull))"); } } while (0); Identity_ptr; }))
                                                                                        ;
...
# 96 "interface/addressable/PacketHeaderToUDPAddrIface.c"
    ...
    do {             struct Er_Ret* Er_ret = Message_eshift(message, -(40 + 8));                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("PacketHeaderToUDPAddrIface.c", 99, Er_ret);                 } else {                     Er__assertFail(Er_unwind("PacketHeaderToUDPAddrIface.c", 99, Er_ret));                 }             }                  } while (0);
    do {             struct Er_Ret* Er_ret = Message_epush(message, addr, addr->addrLen);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("PacketHeaderToUDPAddrIface.c", 100, Er_ret);                 } else {                     Er__assertFail(Er_unwind("PacketHeaderToUDPAddrIface.c", 100, Er_ret));                 }             }                  } while (0);
                                                                  ...
                                                                  struct Sockaddr* addr)
{
    ...
    (context)->Identity_verifier = ((unsigned long) 0xfe5a0cc03456ccc6ull);
