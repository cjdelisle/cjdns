...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0895422044332594;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x04571417435649805;
...
struct Linker_x0406699554986073;
...
# 1 "./util/CString.h" 1
# 21 "./util/CString.h"
struct Linker_x036064537343086855;
...
struct Linker_x09430801938700042;
...
# 21 "./util/ArrayList.h"
struct Linker_x04454913010162149;
...
# 1 "./exception/Er.h" 1
# 23 "./exception/Er.h"
struct Linker_x09766179827029597;
...
struct Linker_x05384124545378837;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x04504294559151931;
...
struct Linker_x06464367416962273;
...
struct Linker_x005836676386138473;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x07790884595081793;
...
struct Linker_x03670431837472008;
...
# 1 "./wire/Message.h" 1
# 23 "./wire/Message.h"
struct Linker_x05196612846014776;
...
struct Linker_x019324182907044118;
...
struct Linker_x005280093524000007;
...
struct Linker_x010604914718492564;
...
struct Linker_x0463703076627316;
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x047978173190090234;
# 32 "./util/Hex.h"
...
struct Linker_x09788286648994249;
...
# 106 "./crypto/test/CryptoAuth_unit_test.c"
    ...
    do {             struct Er_Ret* Er_ret = Message_epush(msg, "Hello World", 12);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("CryptoAuth_unit_test.c", 108, Er_ret);                 } else {                     Er__assertFail(Er_unwind("CryptoAuth_unit_test.c", 108, Er_ret));                 }             }                  } while (0);
...
# 173 "./crypto/test/CryptoAuth_unit_test.c"
                                   , "wxyzabcdefghijklmnopqrstuv987654", "password", alloc);
    struct Message* msg = Message_new(0, 120 + 12, alloc);
    do {             struct Er_Ret* Er_ret = Message_epush(msg, "Hello World", 12);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("CryptoAuth_unit_test.c", 175, Er_ret);                 } else {                     Er__assertFail(Er_unwind("CryptoAuth_unit_test.c", 175, Er_ret));                 }             }                  } while (0);

    do { if (!((!CryptoAuth_encrypt(ctx->sess, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (177), "(!CryptoAuth_encrypt(ctx->sess, msg))"); } } while (0);

    Message_reset(msg);
    do {             struct Er_Ret* Er_ret = Message_epush(msg, "Hello World", 12);                          if (Er_ret) {                 struct Er_Ret** Er_errOut = (struct Er_Ret**)0;                 if (Er_errOut) {                     *Er_errOut = Er_unwind("CryptoAuth_unit_test.c", 180, Er_ret);                 } else {                     Er__assertFail(Er_unwind("CryptoAuth_unit_test.c", 180, Er_ret));                 }             }                  } while (0);
